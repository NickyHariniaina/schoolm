...
import static hei.student.schoolm.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import hei.student.schoolm.PojaGenerated;
import hei.student.schoolm.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "hei.student.schoolm.event1";
    return "hei.student.schoolm.event2";
  }
}
