package hei.student.schoolm.endpoint.event.consumer;

import hei.student.schoolm.PojaGenerated;
import hei.student.schoolm.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("hei.student.schoolm.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "hei.student.schoolm.service.event."
